      ...
      <Card className="w-full max-w-md relative bg-white/95 backdrop-blur shadow-2xl border-0">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="text-slate-500">
            Discordサーバーの分析ダッシュボード
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6 pt-4">
          <div className="space-y-2 text-center text-sm text-slate-600">
            <p>サーバーのメンバー動向やアクティビティを</p>
            <p>リアルタイムで可視化・分析できます</p>
          </div>

          <Button
            onClick={handleDiscordLogin}
            className="w-full h-12 bg-[#5865F2] hover:bg-[#4752c4] text-white font-medium rounded-xl transition-all hover:shadow-lg"
          >
            <svg
          ...
          <div className="text-center text-xs text-slate-400">
            <p>ログインすると、サーバーの分析データにアクセスできます</p>
          </div>
        </CardContent>
      </Card>
    </div>
